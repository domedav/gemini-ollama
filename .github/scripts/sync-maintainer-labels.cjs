 ...
 * - Skips DUPLICATES.
 * - Skips Pull Requests.
 * - ONLY labels issues in the PUBLIC (gemini-ollama) repo.
 */

const REPO_OWNER = 'domedav';
const PUBLIC_REPO = 'gemini-ollama';
const PRIVATE_REPO = 'maintainers-gemini-ollama';
 ...
 * e.g. - [ ] #123 or - [x] domedav/gemini-ollama#123
 */
