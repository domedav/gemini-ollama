 ...
 * not created by members of the 'gemini-ollama-maintainers' team.
 *
...
const ORG = 'domedav';
const TEAM_SLUG = 'gemini-ollama-maintainers';
const DISCUSSION_URL =
  'https://github.com/domedav/gemini-ollama/discussions/16706';
...
async function main() {
  ...
  const commentBody =
    "\nHi @{AUTHOR}, thank you so much for your contribution to Gemini Ollama! We really appreciate the time and effort you've put into this.\n\nWe're making some updates to our contribution process to improve how we track and review changes. Please take a moment to review our recent discussion post: [Improving Our Contribution Process & Introducing New Guidelines](${DISCUSSION_URL}).\n\nKey Update: Starting **January 26, 2026**, the Gemini Ollama project will require all pull requests to be associated with an existing issue. Any pull requests not linked to an issue by that date will be automatically closed.\n\nThank you for your understanding and for being a part of our community!\n  ".trim();
