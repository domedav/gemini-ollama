          ...
          paths: [
            {
              ...
              message:
                'Please use the helpers from gemini-ollama-core instead of node:os homedir()/tmpdir() to ensure strict environment isolation.',
            },
            {
              name: 'os',
              importNames: ['homedir', 'tmpdir'],
              message:
                'Please use the helpers from gemini-ollama-core instead of os homedir()/tmpdir() to ensure strict environment isolation.',
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: 'gemini-ollama-core',
          message: 'Please use relative imports within the gemini-ollama-core package.',
        },
      ],
    },
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        ...
        {
          name: 'gemini-ollama',
          message: 'Please use relative imports within the gemini-ollama package.',
        },
      ],
    },
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: 'gemini-ollama-sdk',
          message: 'Please use relative imports within the gemini-ollama-sdk package.',
        },
      ],
    },
  },
