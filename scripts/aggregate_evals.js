...
function generateMarkdown(currentStatsByModel, history) {
  ...
  console.log(
    'See [evals/README.md](https://github.com/domedav/gemini-ollama/tree/main/evals) for more details.\n',
  );
  ...
  for (const model of models) {
    ...
    for (const name of Array.from(allTestNames).sort()) {
      const searchUrl = `https://github.com/search?q=repo%3Adomedav%2Fgemini-ollama%20%22${encodeURIComponent(name)}%22&type=code`;
