...
const SCHEMA_ID =
  'https://raw.githubusercontent.com/domedav/gemini-ollama/main/schemas/settings.schema.json';
...
function buildSchemaObject(schema: SettingsSchemaType): JsonSchema {
  ...
  const root: JsonSchema = {
    ...
    $id: SCHEMA_ID,
    title: 'Gemini Ollama Settings',
    description:
      'Configuration file schema for Gemini Ollama settings. This schema enables IDE completion for `settings.json`.',
    type: 'object',
