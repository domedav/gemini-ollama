...
describe('patch-create-comment', () => {
  ...
  describe('Environment flag', () => {
    it('can be overridden with a flag', () => {
      ...
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 0 --environment prod --commit abc1234 --channel preview --repository domedav/gemini-ollama --test',
      );
    ...
    it('reads from the ENVIRONMENT env variable', () => {
      vi.stubEnv('ENVIRONMENT', 'dev');
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 0 --commit abc1234 --channel preview --repository domedav/gemini-ollama --test',
      );
  ...
  describe('Environment Variable vs File Reading', () => {
    ...
    it('should use empty log content when LOG_CONTENT is not set', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 1 --commit abc1234 --channel stable --repository domedav/gemini-ollama --test',
  ...
  describe('Log Content Parsing - Success Scenarios', () => {
    it('should generate success comment for clean cherry-pick', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 0 --commit abc1234 --channel stable --repository domedav/gemini-ollama --test',
        {
          LOG_CONTENT:
    ...
    it('should generate conflict comment for cherry-pick with conflicts', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 0 --commit def5678 --channel preview --repository domedav/gemini-ollama --test',
        {
          LOG_CONTENT:
  ...
  describe('Log Content Parsing - Existing PR Scenarios', () => {
    it('should detect existing PR and generate appropriate comment', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 0 --commit ghi9012 --channel stable --repository domedav/gemini-ollama --test',
        {
          LOG_CONTENT:
            'Hotfix branch hotfix/v0.4.1/stable/cherry-pick-ghi9012 already has an open PR.\nFound existing PR #8700: https://github.com/domedav/gemini-ollama/pull/8700',
        },
      );
      ...
      expect(result.stdout).toContain(
        'A patch PR for this change already exists: [#8700](https://github.com/domedav/gemini-ollama/pull/8700)',
      );
      expect(result.stdout).toContain(
    ...
    it('should detect branch exists but no PR scenario', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 0 --commit jkl3456 --channel preview --repository domedav/gemini-ollama --test',
        {
          LOG_CONTENT:
  ...
  describe('Log Content Parsing - Failure Scenarios', () => {
    it('should generate failure comment when exit code is non-zero', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 1 --commit mno7890 --channel stable --repository domedav/gemini-ollama --run-id 12345 --test',
        {
      ...
      expect(result.stdout).toContain(
        'View workflow run](https://github.com/domedav/gemini-ollama/actions/runs/12345)',
      );
    });

    it('should generate fallback failure comment when no output is generated', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 1 --commit pqr4567 --channel preview --repository domedav/gemini-ollama --run-id 67890 --test',
        {
          LOG_CONTENT: '',
        },
      );
  ...
  describe('Channel and NPM Tag Detection', () => {
    it('should correctly map stable channel to latest npm tag', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 0 --commit stu8901 --channel stable --repository domedav/gemini-ollama --test',
        {
          LOG_CONTENT:
    ...
    it('should correctly map preview channel to preview npm tag', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 0 --commit vwx2345 --channel preview --repository domedav/gemini-ollama --test',
        {
          LOG_CONTENT:
  ...
  describe('No Original PR Scenario', () => {
    it('should skip comment when no original PR is specified', () => {
      const result = runPatchCreateComment(
        '--original-pr 0 --exit-code 0 --commit yza6789 --channel stable --repository domedav/gemini-ollama --test',
        {
          LOG_CONTENT:
  ...
  describe('Error Handling', () => {
    it('should handle empty LOG_CONTENT gracefully', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 1 --commit bcd0123 --channel stable --repository domedav/gemini-ollama --test',
...
\`\`\``,
  ...
  describe('Test Mode Flag', () => {
    it('should generate mock content in test mode for success', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 0 --commit efg4567 --channel preview --repository domedav/gemini-ollama --test',
      );
    ...
    it('should generate mock content in test mode for failure', () => {
      const result = runPatchCreateComment(
        '--original-pr 8655 --exit-code 1 --commit hij8901 --channel stable --repository domedav/gemini-ollama --test',
      );
