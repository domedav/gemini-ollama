...
function main() {
  ...
  if (regressions.length > 0) {
    ...
    for (let i = 0; i < regressions.length; i++) {
      ...
      markdown += '#### 1. Ask Gemini Ollama to fix it (Recommended)\n';
    ...
    markdown +=
      'See the [Fixing Guide](https://github.com/domedav/gemini-ollama/blob/main/evals/README.md#fixing-evaluations) for detailed troubleshooting steps.\n';
    markdown += '</details>\n';
