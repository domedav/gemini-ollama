...
async function main() {
  const argv = await yargs(hideBin(process.argv))
    ...
    .example(
      '$0 --original-pr 8655 --exit-code 0 --commit abc1234 --channel preview --repository domedav/gemini-ollama --test',
      'Test success comment',
    )
    .example(
      '$0 --original-pr 8655 --exit-code 1 --commit abc1234 --channel stable --repository domedav/gemini-ollama --test',
  ...
  const repository =
    argv.repository || process.env.REPOSITORY || 'domedav/gemini-ollama';
