...
- Perform the following edits on the target file:
    ...
    5.  In the "Full Changelog", edit **only** the end of the URL. Identify the
        ...
        `Full Changelog: https://github.com/domedav/gemini-ollama/compare/v0.28.2…v0.29.0`
        to
        `Full Changelog: https://github.com/domedav/gemini-ollama/compare/v0.28.2…v0.29.1`
...
- Perform the following edits on the target file:
    ...
    5.  In the "Full Changelog", edit **only** the end of the URL. Identify the
        ...
        `Full Changelog: https://github.com/domedav/gemini-ollama/compare/v0.28.2…v0.29.0-preview.0`
        to
        `Full Changelog: https://github.com/domedav/gemini-ollama/compare/v0.28.2…v0.29.0-preview.1`
