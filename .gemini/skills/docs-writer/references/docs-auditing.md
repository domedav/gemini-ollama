...
This guide outlines the process for auditing the Gemini Ollama documentation for
...
the Gemini Ollama documentation style guide, and reflects the current state of the
codebase.
    ...
    - **Review against Style Guide:**
      ...
      - **Formatting and Syntax Violations:**
        ...
        - **Casing:** Identify incorrect casing for headings, titles, or named
          entities (e.g., product names like `Gemini Ollama`).
