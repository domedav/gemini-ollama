...
- **Keyboard Handling**: Keyboard handling MUST go through `useKeyPress.ts` from
  the Gemini Ollama package rather than the standard ink library. This library
...
## General Gemini Ollama Design Principles
...
- **Prompts**: Be aware that changes can impact the prompts sent to Gemini Ollama
