# RFC: Gemini Ollama A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the Gemini Ollama agent, this document
...
required for rich, interactive workflows with the Gemini Ollama agent.

### 1.2 Motivation

Recent work integrating Gemini Ollama with clients like Zed and Gemini Code
...
- **Ecosystem Alignment**: Aligns Gemini Ollama with a growing industry standard,
...
workflows between a client and the Gemini Ollama agent. It consists of a
...
```json
{
  "name": "Gemini Ollama Agent",
  "description": "An agent that generates code based on natural language instructions.",
  "capabilities": {
    "streaming": true,
    "extensions": [
      {
        "uri": "https://github.com/domedav/gemini-ollama/blob/main/docs/a2a/developer-profile/v0/spec.md",
...
// Configuration settings for the Gemini Ollama agent.
