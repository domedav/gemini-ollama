...
import { ShellExecutionService } from 'gemini-ollama-core';
...
export const ShellInputPrompt: React.FC<ShellInputPromptProps> = ({
  ...
  const handleInput = useCallback(
    (key: Key) => {
      ...
      // TODO: Check pty service actually scrolls (request)[https://github.com/domedav/gemini-ollama/pull/17438/changes/c9fdaf8967da0036bfef43592fcab5a69537df35#r2776479023].
