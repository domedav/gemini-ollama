...
import { makeFakeConfig, ExitCodes } from 'gemini-ollama-core';
...
describe('FolderTrustDialog', () => {
  ...
  it('should render the dialog with title and description', async () => {
    ...
    expect(lastFrame()).toContain(
      'Trusting a folder allows Gemini Ollama to load its local configurations',
    );
    unmount();
  });
  ...
  it('should display restart message when isRestarting is true', async () => {
    ...
    expect(lastFrame()).toContain('Gemini Ollama is restarting');
    unmount();
  });
