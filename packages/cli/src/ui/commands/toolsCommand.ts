...
const listSubCommand: SlashCommand = {
  name: 'list',
  description: 'List available Gemini Ollama tools.',
...
const descSubCommand: SlashCommand = {
  ...
  description: 'List available Gemini Ollama tools with descriptions.',
  kind: CommandKind.BUILT_IN,
  autoExecute: true,
  action: async (context: CommandContext): Promise<void> =>
...
export const toolsCommand: SlashCommand = {
  name: 'tools',
  description:
    'List available Gemini Ollama tools. Use /tools desc to include descriptions.',
  kind: CommandKind.BUILT_IN,
  autoExecute: false,
