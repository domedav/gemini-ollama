...
Gemini Ollama extension. It demonstrates how to expose tools and prompts to the
Gemini Ollama.
...
- `gemini-extension.json`: The configuration file that tells Gemini Ollama how to
  use this extension.
