...
import { ExitCodes } from 'gemini-ollama-core';
  ...
  describe('runDeferredCommand', () => {
    ...
    it('should exit with FATAL_CONFIG_ERROR if MCP is disabled', async () => {
      ...
      expect(mockCoreEvents.emitFeedback).toHaveBeenCalledWith(
        'error',
        'MCP is disabled by your administrator. To enable it, please request an update to the settings at: https://goo.gle/manage-gemini-ollama',
      );
      expect(mockRunExitCleanup).toHaveBeenCalled();
    ...
    it('should exit with FATAL_CONFIG_ERROR if extensions are disabled', async () => {
      ...
      expect(mockCoreEvents.emitFeedback).toHaveBeenCalledWith(
        'error',
        'Extensions is disabled by your administrator. To enable it, please request an update to the settings at: https://goo.gle/manage-gemini-ollama',
      );
      expect(mockRunExitCleanup).toHaveBeenCalled();
      expect(mockExit).toHaveBeenCalledWith(ExitCodes.FATAL_CONFIG_ERROR);
    });
    ...
    it('should exit with FATAL_CONFIG_ERROR if skills are disabled', async () => {
      ...
      expect(mockCoreEvents.emitFeedback).toHaveBeenCalledWith(
        'error',
        'Agent skills is disabled by your administrator. To enable it, please request an update to the settings at: https://goo.gle/manage-gemini-ollama',
      );
      expect(mockRunExitCleanup).toHaveBeenCalled();
      expect(mockExit).toHaveBeenCalledWith(ExitCodes.FATAL_CONFIG_ERROR);
    });
