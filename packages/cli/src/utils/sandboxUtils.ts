...
import { debugLogger, GEMINI_DIR } from 'gemini-ollama-core';

export const LOCAL_DEV_SANDBOX_IMAGE_NAME = 'gemini-ollama-sandbox';
export const SANDBOX_NETWORK_NAME = 'gemini-ollama-sandbox';
export const SANDBOX_PROXY_NAME = 'gemini-ollama-sandbox-proxy';
