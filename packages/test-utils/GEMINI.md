# Gemini Ollama Test Utils (`gemini-ollama-test-utils`)
...
1. **Programmatic Builder:**
   ...
   ```typescript
   import { TestMcpServerBuilder } from 'gemini-ollama-test-utils';
...
Import from `gemini-ollama-test-utils` in test files across the monorepo.
