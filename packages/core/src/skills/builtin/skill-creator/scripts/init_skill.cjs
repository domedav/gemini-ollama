...
**Note:** Scripts may be executed without loading into context, but can still be read by Gemini Ollama for patching or environment adjustments.

### references/
Documentation and reference material intended to be loaded into context to inform Gemini Ollama's process and thinking.
...
**Appropriate for:** In-depth documentation, API references, database schemas, comprehensive guides, or any detailed information that Gemini Ollama should reference while working.
