    ...
    const testCases: FsErrorCase[] = [
      {
        ...
        path: '/etc/gemini-ollama/settings.json',
        expected:
          "Permission denied: cannot access '/etc/gemini-ollama/settings.json'. Check file permissions or run with elevated privileges.",
      },
      {
        code: 'EACCES',
        message: 'EACCES: permission denied',
