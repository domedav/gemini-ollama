...
export function renderPreamble(options?: PreambleOptions): string {
  ...
  const base = options.interactive
    ? 'You are Gemini Ollama, an interactive CLI agent specializing in software engineering tasks.'
    : 'You are Gemini Ollama, an autonomous CLI agent specializing in software engineering tasks.';
