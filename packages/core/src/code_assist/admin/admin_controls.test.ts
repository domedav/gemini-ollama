...
describe('Admin Controls', () => {
  ...
  describe('getAdminErrorMessage', () => {
    ...
    it('should include feature name and project ID when present', () => {
      ...
      expect(message).toBe(
        'Code Completion is disabled by your administrator. To enable it, please request an update to the settings at: https://goo.gle/manage-gemini-ollama?project=test-project-123',
      );
    });
    ...
    it('should include feature name but OMIT project ID when missing', () => {
      ...
      expect(message).toBe(
        'Chat is disabled by your administrator. To enable it, please request an update to the settings at: https://goo.gle/manage-gemini-ollama',
      );
    });
  ...
  describe('getAdminBlockedMcpServersMessage', () => {
    ...
    it('should show count for a single blocked server', () => {
      ...
      expect(message).toBe(
        '1 MCP server is not allowlisted by your administrator. To enable it, please request an update to the settings at: https://goo.gle/manage-gemini-ollama?project=test-project-123',
      );
    });
    ...
    it('should show count for multiple blocked servers', () => {
      ...
      expect(message).toBe(
        '3 MCP servers are not allowlisted by your administrator. To enable them, please request an update to the settings at: https://goo.gle/manage-gemini-ollama?project=test-project-123',
      );
    });
    ...
    it('should format message correctly with no project ID', () => {
      ...
      expect(message).toBe(
        '2 MCP servers are not allowlisted by your administrator. To enable them, please request an update to the settings at: https://goo.gle/manage-gemini-ollama',
      );
    });
  });
});
