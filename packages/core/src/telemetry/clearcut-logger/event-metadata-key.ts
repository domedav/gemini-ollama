...
export enum EventMetadataKey {
  ...
  // Logs the Surface from where the Gemini Ollama was invoked, eg: VSCode.
  GEMINI_CLI_SURFACE = 39,

  // Logs the session id
  GEMINI_CLI_SESSION_ID = 40,

  // Logs the Gemini Ollama version
  GEMINI_CLI_VERSION = 54,

  // Logs the Gemini Ollama Git commit hash
  GEMINI_CLI_GIT_COMMIT_HASH = 55,

  // Logs the Gemini Ollama OS
  GEMINI_CLI_OS = 82,
