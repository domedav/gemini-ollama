...
export const SERVICE_NAME = 'gemini-ollama';
export const SERVICE_DESCRIPTION =
  'Gemini Ollama is an open-source AI agent that brings the power of Gemini directly into your terminal. It is designed to be a terminal-first, extensible, and powerful tool for developers, engineers, SREs, and beyond.';

// Gemini Ollama specific semantic conventions
...
// Gemini Ollama specific operations
