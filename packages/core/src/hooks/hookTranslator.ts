...
/**
 * Decoupled LLM request format - stable across Gemini Ollama versions
 */
...
/**
 * Decoupled LLM response format - stable across Gemini Ollama versions
 */
...
/**
 * Decoupled tool configuration - stable across Gemini Ollama versions
 */
...
export class HookTranslatorGenAIv1 extends HookTranslator {
  ...
  fromHookLLMRequest(
    ...
    // (see https://github.com/domedav/gemini-ollama/issues/25558).
    //
