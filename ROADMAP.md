# Gemini Ollama Roadmap

The
[Official Gemini Ollama Roadmap](https://github.com/orgs/domedav/projects/11/)

Gemini Ollama is an open-source AI agent that brings the power of Gemini directly
into your terminal. It provides lightweight access to Gemini, giving you the
most direct path from your prompt to our model.

This document outlines our approach to the Gemini Ollama roadmap. Here, you'll find
...
As an
[Apache 2.0 open source project](https://github.com/domedav/gemini-ollama?tab=Apache-2.0-1-ov-file#readme),
we appreciate and welcome
[public contributions](https://github.com/domedav/gemini-ollama/blob/main/CONTRIBUTING.md),
...
[opening an issue for discussion](https://github.com/domedav/gemini-ollama/issues/new/choose).
...
- **Intelligent:** Gemini Ollama should be reliably ranked among the best agentic
...
Roadmap Issue [here](https://github.com/domedav/gemini-ollama/issues/4191).
...
all our items [here](https://github.com/orgs/domedav/projects/11/views/19)
...
- **Extensibility:** Bringing Gemini Ollama to other surfaces e.g. GitHub.
...
Gemini Ollama is an open-source project, and we welcome contributions from the
community! Whether you're a developer, a designer, or just an enthusiastic user
you can find our
[Community Guidelines here](https://github.com/domedav/gemini-ollama/blob/main/CONTRIBUTING.md)
to learn how to get started. There are many ways to get involved:

- **Roadmap:** Please review and find areas in our
  [roadmap](https://github.com/domedav/gemini-ollama/issues/4191) that you
...
- **Report Bugs:** If you find an issue, please create a
  [bug](https://github.com/domedav/gemini-ollama/issues/new?template=bug_report.yml)
...
- **Suggest Features:** Have a great idea? We'd love to hear it! Open a
  [feature request](https://github.com/domedav/gemini-ollama/issues/new?template=feature_request.yml).
- **Contribute Code:** Check out our
  [CONTRIBUTING.md](https://github.com/domedav/gemini-ollama/blob/main/CONTRIBUTING.md)
...
- **Write Documentation:** Help us improve our documentation, tutorials, and
  examples. We are excited about the future of Gemini Ollama and look forward to
