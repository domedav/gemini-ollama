...
- **Architecture:** Monorepo structure using npm workspaces.
  ...
  - `packages/sdk`: Programmatic SDK for embedding Gemini Ollama capabilities.
...
- **Test Commands:**
  ...
  - **Workspace-Specific:** `npm test -w <pkg> -- <path>` (Note: `<path>` must
    ...
    `-w gemini-ollama-core -- src/routing/modelRouterService.test.ts`)
