...
> [!TIP] **Agent Automation**: If you are pair-programming with Gemini Ollama, you
...
First, build the bundled Gemini Ollama. You must do this after every code change.
...
The
[Evals: Nightly](https://github.com/domedav/gemini-ollama/actions/workflows/evals-nightly.yml)
...
- **CI Evals**: Included in the
  [E2E (Chained)](https://github.com/domedav/gemini-ollama/actions/workflows/chained_e2e.yml)
